...
RULES: list[dict] = [
    ...
    {"field": 0x20, "op": "add", "const": 0xB2FCE189, "base": "payload",
     "entry_size": None, "consumer_rvas": ["0x3C6682D"], "entry_accesses": ["base only"],
    ...
    {"field": 0x14C, "op": "add", "const": 0xF3A04294, "base": "payload",
     "entry_size": 26, "consumer_rvas": ["0x3C66FBA", "0x3C71362", "0x3C7D45C"],
     "entry_accesses": ["idx*26", "[+0x10] xor-decode", "feeds 0x3C66940"],
     "semantic": "26-byte usage resolution records (candidate)", "structure": "CONFIRMED",
     "semantic_status": "SUPPORTED", "semantic_evidence": "0x3C66F80-0x3C67082"},
...
def build_registry(pe: PeImage, metadata_path: Path | None, template_rva: int) -> dict:
    ...
    return {
        ...
        "not_claimed": [
            ...
            "MethodDefinition / FieldDefinition table identity",
