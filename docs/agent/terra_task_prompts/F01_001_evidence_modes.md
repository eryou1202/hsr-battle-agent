# F01-001 — EvidenceMode and VersionRelation enums
...
- Do not implement ContractRef, UnknownHandle, provenance v2 or runtime gating in this task.
- Do not map historical EXECUTABLE_REFERENCE to SAFE_TO_IMPLEMENT.
